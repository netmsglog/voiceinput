...
1. Download `VoiceInput-v0.2.0.zip` from [Releases](https://github.com/netmsglog/voiceinput/releases)
   从 [Releases](https://github.com/netmsglog/voiceinput/releases) 下载 `VoiceInput-v0.2.0.zip`
